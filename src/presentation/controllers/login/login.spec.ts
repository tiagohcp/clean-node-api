...
import { Authentication } from '../../../domain/usecases/authenticaton'
...
describe('Login Controller', () => {
  ...
  test('Should return 400 if an invalid password is provider', async () => {
  ...
  test('Should calls EmailValidator with correct valeus', async () => {
  ...
  test('Should return 401 if invalid credentials are provided', async () => {
    ...
    const httpRequest = await sut.handle(makeFakeRequest())
    expect(httpRequest).toEqual(unautorized())
  })
})
